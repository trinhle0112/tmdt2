...
(function($) {
    ...
    AIHELLOAUTOPILOT.initialize = {
        ...
        general: function() {
            ...
            /**THIS NEXT COMMENTED SCRIPT HAS BEEN MOVED
             * TO SCRIPT AT 'home/index.html' file */
            // /** Pricing Tabs */
            ...
            //     // TODO: Enable that until the registration endpoint supports
            //     // if ($('.pricing-tab-switcher').hasClass('active')) {
            //     //     $('.get-started-plan').each(function() {
            //     //         var href = $(this).attr('href') + '&annual=true';
            //     //         $(this).attr('href', href);
            //     //     });
            //     // } else {
            //     //     $('.get-started-plan').each(function() {
            //     //         var href = $(this).attr('href');
            //     //         $(this).attr('href', href.replace('&annual=true', ''));
